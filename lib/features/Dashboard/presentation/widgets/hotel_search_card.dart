...
class HotelSearchCard extends StatelessWidget {
  ...
  const HotelSearchCard({super.key, required this.hotel, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: onTap,
      child: Hero(
        tag: hotel.propertyCode + hotel.propertyImage.fullUrl,
        child: Material(
                ...
                Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(hotel.markedPrice.displayAmount,
                                style: TextStyle(
                                    color: teal.shade700,
